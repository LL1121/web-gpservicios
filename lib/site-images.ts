...
/** Fondo del bloque "Resumen ejecutivo" en la home —
 *  refinería con cañerías (Trzebinia, Polonia) — coincide con el discurso
 *  de "ingeniería, construcción y montaje en Petróleo y Gas". */
export const homeExecutiveImage = UNSPLASH('photo-1678984240126-70bcddd7a228', 2400)
...
export const serviceImages: Record<ServiceSlug, string> = {
  ...
  'prefabricado-lac-pluspetrol': UNSPLASH('photo-1582719188393-bb71ca45dbb9'),
  ...
  'arenado-pintura':             UNSPLASH('photo-1623461487986-9400110de28e'),
